...
python make_vocab.py  --src_path ../output/train_Simply  --vocab_path ../output/vocab --add_answer True
...
python train.py --vocab_path ../output/vocab --test train --data_path ../output/train_add_answer --is_training True\
     --use_pretrain_vector  false --vector_path word-vector --num_units 128 --input_embedding_size 200 --batch_size 10\
     --keep_pro 0.7
